...
export default function Watch() {
  ...
  useEffect(() => {
    ...
    // Fetch video details and related videos in background
  ...
  // Show error state if video ID is invalid or video fails to load
  if (error) {
    return (
    ...
    <div className="watch-page">
      <div className="container">
        <div className="video-container">
          ...
          {/* Related Videos Sidebar - Shows when loaded */}
